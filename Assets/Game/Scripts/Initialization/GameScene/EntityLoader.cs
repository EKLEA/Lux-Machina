...
//         _entityManager.AddComponentData(entity, new CreateBuildingEventComponent());
...
//                 _entityManager.AddComponentData(entity, new BluePrint());
//             // if (gameState.demolitionBuildings.Contains(entityId))
//             //     _entityManager.AddComponentData(entity, new MakeDemolitionTag());
//         }
//     }
...
//             if (isBluePrint)
//                 gameState.phantomBuildings.Add(buildingData.UniqueIDHash);
//             CreateSavedBuildingEntity(buildingData.UniqueIDHash, gameState);
//         }
//     }

//     public void CreateRoad(
//         HashSet<Vector2Int> roadPoints,
//         bool isBluePrint,
//         GameStateData gameState
//     )
//     {
...
//         else
//             selectedRoads = gameState.roadPoints;
